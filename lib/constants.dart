...
/*Future<List<AyaModel>> getJson() async {
  //charger le fichier json à partir de 'assets/quran.json'
  String jsonString = await rootBundle.loadString('assets/quraan.json');
  //décodage des données json
  var jsonData = json.decode(jsonString);
  //obtenir quran (Ayats) des donnée json
  List<dynamic> jsonArray = jsonData[
  'quran'];//en supposant 'quran' est la clé du tableau dans votre  json
  //parcourir la liste ayats json et convertir chaque modéle aya json en modéle aya
